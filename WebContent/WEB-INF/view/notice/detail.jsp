...
<%-- <%
// 아래 블럭이 전체 컨트롤 부분이 되는 것임. MVC 의 C 부분임.  
...
//Statement st = con.createStatement(); //변수를 전달 받기위해서는 아래의 프리페어스테이트먼르를 써양됨.
...
//[ST] MVC 의 모델이 되는 것임.  --> 추후 엔티티 형식으로 전화 될 예정 아마 자바에서 구현 될것임.
...
<!-- 아래의 부분은 View 부분이 되는 것임 MVC 의 V부분임. -->
<!DOCTYPE html>
<html>
						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td>${n.writerId}</td>
									<th>조회수</th>
									<td><fmt:formatNumber type="number" pattern="#,### 번조회" value="${n.hit}" /> </td>
								</tr>
								<tr>
									<th>첨부파일</th>
